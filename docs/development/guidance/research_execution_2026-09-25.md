...
The [connected-motif simulator contract](protocol_connected_motif_v0.md) now has a DAG, forward sampler, action menu, and natural-child mask for interventions on upstream children. Its local smoke check passes. It does not yet contain the matched persistent policies or sealed evaluator; no connected-motif jobs have been submitted or scored.
