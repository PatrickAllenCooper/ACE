...
#   scp -r paco0228@login.rc.colorado.edu:/scratch/alpine/paco0228/ACE/results/curc_30node_followup ./results/
# =============================================================================
...
OUT="/scratch/alpine/paco0228/ACE/results/curc_30node_followup"
mkdir -p "$OUT/logs"
