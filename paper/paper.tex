...
Baseline comparisons show Max-Variance achieves the best performance (2.05 $\pm$ 0.12), closely followed by PPO (2.11 $\pm$ 0.13) and Round-Robin (2.15 $\pm$ 0.08), with Random performing worst (2.18 $\pm$ 0.06). These results demonstrate that uncertainty-based methods provide advantages over unguided or systematic strategies for mechanism learning.
