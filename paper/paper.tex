...
The result is a system that can assist experimentalists in practice: suggesting which experiment to run next based on current knowledge, learning from outcomes to improve future suggestions, and adapting to domain-specific constraints like intervention costs or time limits. For the experimentalist facing thousands of possible next experiments, ACE provides data-driven guidance that improves with experience.
