...
\begin{table}[t]
\centering
\caption{Main results on the 5-node synthetic benchmark. All methods evaluated over N=5 seeds. ACE significantly outperforms all baselines with large effect sizes. $^{**}$p<0.01, $^{*}$p<0.0125 (Bonferroni corrected).}
\label{tab:main-results}
\begin{tabular}{lcccc}
\toprule
Method & Loss (mean $\pm$ std) & 95\% CI & Improv. & Cohen's d \\
\midrule
\textbf{ACE (ours)} & \textbf{0.92 $\pm$ 0.73} & [0.02, 1.82] & -- & -- \\
\quad median & 0.61 & & & \\
\midrule
Max-Variance & 1.93 $\pm$ 0.04 & [1.80, 2.06] & +52\% & $-$1.96 \\
