...
echo "========================================"
echo ""
echo "OPTION 1: Automatic post-processing ON HPC after jobs complete:"
echo "  # Wait for all jobs to finish, then run:"
echo "  ./scripts/process_all_results.sh $OUT"
echo ""
echo "OPTION 2: Download results to LOCAL machine and process:"
echo "  # On your local machine, run:"
echo "  ./scripts/sync_results_from_hpc.sh"
echo "  # This will:"
echo "  - Download latest results from HPC"
echo "  - Run post-processing locally"
echo "  - Generate all tables and figures"
echo ""
echo "Either way, post-processing will:"
echo "  - Extract all metrics"
echo "  - Verify all paper claims (Lines 485, 661, 714, 767)"
echo "  - Generate Table 1"
echo "  - Organize all figures"
echo "  - Create summary report"
echo ""
echo "Outputs will be in: $OUT/processed/"
echo ""
echo "Note: Post-processing can run on HPC OR locally after downloading."
echo "      Choose based on your workflow preference."
echo ""
