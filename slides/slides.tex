...
\item All methods on the same MLP student learner for fair comparison.
\end{itemize}
\end{frame}
...
\centering
\includegraphics[width=0.80\textwidth]{fig_30node_results.pdf}\\[0.2em]
\flushleft
\small
\begin{itemize}\itemsep=0.1em
\item ACE: $\mathbf{1.95\pm0.77}$ best-loss vs.\ baselines plateau $\mathbf{5.86}$ (stds $<\!0.08$).
\item Common-plateau finding: at scale, static sampling heuristics are indistinguishable.
